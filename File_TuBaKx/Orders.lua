...
------------------------------------------hso----------------------------------
if text == ("مسح قائمه العام") and Sudo_TuBaKx(msg) then
redis:del(TuBaKx..'GBan:User')
send(msg.chat_id_, msg.id_, '\n܁༯┆تم مسـح قائمةه العام 💞 ܰ')
return false
end

if text == ("قائمه العام") and Sudo_TuBaKx(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and Sudo_TuBaKx(msg) then
...
redis:sadd(TuBaKx..'GBan:User', result.sender_user_id_)
...
if text and text:match("^حظر عام @(.*)$")  and Sudo_TuBaKx(msg) then
...
redis:sadd(TuBaKx..'GBan:User', result.id_)
else
...
if text and text:match("^حظر عام (%d+)$") and Sudo_TuBaKx(msg) then
...
redis:sadd(TuBaKx..'GBan:User', userid)
...
if text == ("كتم عام") and msg.reply_to_message_id_ and Sudo_TuBaKx(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_, msg.id_,'- هلو حب ، لايمكنك استخدام البوت 💕.\n- ﭑشترك اولاً 💕 • ['..redis:get(TuBaKx..'add:ch:username')..'] .')
return false
end
...
redis:sadd(TuBaKx..'Gmute:User', result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},
function(arg,data) 
usertext = '\n܁༯┆هلو عمري 💞 ܰ'
...
if text and text:match("^كتم عام @(.*)$")  and Sudo_TuBaKx(msg) then
...
status  = '\n܁༯┆تم كتم العضو عام من المجموعات  💞 ܰ'
texts = usertext..status
redis:sadd(TuBaKx..'Gmute:User', result.id_)
else
texts = '܁༯┆لايوجد حساب بهذا المعرف  💞 ܰ\n'
end
send(msg.chat_id_, msg.id_, texts)
...
if text and text:match("^كتم عام (%d+)$") and Sudo_TuBaKx(msg) then
...
redis:sadd(TuBaKx..'Gmute:User', userid)
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and Sudo_TuBaKx(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_, msg.id_,'- هلو حب ، لايمكنك استخدام البوت 💕.\n- ﭑشترك اولاً 💕 • ['..redis:get(TuBaKx..'add:ch:username')..'] .')
return false
end
...
redis:srem(TuBaKx..'Gmute:User', result.sender_user_id_)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
return false
end
if text and text:match("^الغاء العام @(.*)$") and Sudo_TuBaKx(msg) then
...
redis:srem(TuBaKx..'Gmute:User', result.id_)
else
texts = '܁༯┆لايوجد حساب بهذا المعرف  💞 ܰ'
end
send(msg.chat_id_, msg.id_, texts)
...
if text and text:match("^الغاء العام (%d+)$") and Sudo_TuBaKx(msg) then
local userid = text:match("^الغاء العام (%d+)$")
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_, msg.id_,'- هلو حب ، لايمكنك استخدام البوت 💕.\n- ﭑشترك اولاً 💕 • ['..redis:get(TuBaKx..'add:ch:username')..'] .')
return false
end
redis:srem(TuBaKx..'GBan:User', userid)
redis:srem(TuBaKx..'Gmute:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n܁༯┆هلو عمري 💞 ܰ'
status  = '\n܁༯┆تم الغاء ܊ الحظر ٭ الكتم ܊ عام من المجموعات 💞 ܰ'
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and Sudo_TuBaKx(msg) then
redis:del(TuBaKx..'Sudo:User')
send(msg.chat_id_, msg.id_, "\n܁༯┆تم مسح المطورين 💞 ܰ ")
end
if text == ("المطورين") and Sudo_TuBaKx(msg) then
...
if text == ("رفع مطور") and msg.reply_to_message_id_ and Sudo_TuBaKx(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_, msg.id_,'- هلو حب ، لايمكنك استخدام البوت 💕.\n- ﭑشترك اولاً 💕 • ['..redis:get(TuBaKx..'add:ch:username')..'] .')
return false
end
redis:sadd(TuBaKx..'Sudo:User', result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁༯┆هلو عمري 💞 ܰ'
status  = '\n܁༯┆تم رفع العضو ◃ مطور💞 ܰ'
send(msg.chat_id_, msg.id_, usertext..status)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and Sudo_TuBaKx(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_, msg.id_,'- هلو حب ، لايمكنك استخدام البوت 💕.\n- ﭑشترك اولاً 💕 • ['..redis:get(TuBaKx..'add:ch:username')..'] .')
return false
end
...
redis:del(TuBaKx..'Basic:Constructor'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n܁༯┆تم مسح الاساسين 💞 ܰ')
return false
end

if text == 'المنشئين الاساسين' and Sudo(msg) then
local list = redis:smembers(TuBaKx..'Basic:Constructor'..msg.chat_id_)
t = "\n٭ 𖤓┆قائمة الاساسيين 💞💞◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do
local username = redis:get(TuBaKx.."user:Name" .. v)
if username then
...
function start_function(extra, result, success)
redis:sadd(TuBaKx..'Basic:Constructor'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
...
redis:sadd(TuBaKx..'Basic:Constructor'..msg.chat_id_, result.id_)
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
status  = '\n܁༯┆تم رفع العضو منشى اساسي 💞 ܰ'
texts = usertext..status
else
...
redis:sadd(TuBaKx..'Basic:Constructor'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
status  = '\n܁༯┆تم رفع العضو منشى اساسي 💞 ܰ'
...
function start_function(extra, result, success)
if result.id_ then
redis:srem(TuBaKx..'Basic:Constructor'..msg.chat_id_, result.id_)
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
status  = '\n܁༯┆تم تنزيل العضو ◃ منشى اساسي 💞 ܰ'
texts = usertext..status
else
...
redis:srem(TuBaKx..'Basic:Constructor'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
status  = '\n܁༯┆تم تنزيل العضو ◃ منشى اساسي 💞 ܰ'
...
local list = redis:smembers(TuBaKx..'Constructor'..msg.chat_id_)
t = "\n٭ 𖤓┆قائمة المنشئين 💞💞◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do
local username = redis:get(TuBaKx.."user:Name" .. v)
if username then
...
function start_function(extra, result, success)
redis:sadd(TuBaKx..'Constructor'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
status  = '\n܁༯┆تم رفع العضو منشى 💞 ܰ'
send(msg.chat_id_, msg.id_, usertext..status)
...
redis:sadd(TuBaKx..'Constructor'..msg.chat_id_, result.id_)
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
status  = '\n܁༯┆تم رفع العضو منشى 💞 ܰ'
texts = usertext..status
else
...
redis:sadd(TuBaKx..'Constructor'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
status  = '\n܁༯┆تم رفع العضو منشى 💞 ܰ'
...
function start_function(extra, result, success)
if result.id_ then
redis:srem(TuBaKx..'Constructor'..msg.chat_id_, result.id_)
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
status  = '\n܁༯┆تم تنزيل العضو من المنشئين 💞 ܰ'
texts = usertext..status
else
...
redis:srem(TuBaKx..'Constructor'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
status  = '\n܁༯┆تم تنزيل العضو من المنشئين 💞 ܰ'
...
local list = redis:smembers(TuBaKx..'Owners'..msg.chat_id_)
t = "\n٭ 𖤓┆قائمة المدراء 💞💞◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do
local username = redis:get(TuBaKx.."user:Name" .. v)
if username then
...
redis:sadd(TuBaKx..'Owners'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n܁༯┆هلو عمري 💞 ܰ' 
status  = '\n܁༯┆تم رفع العضو مدير 💞 ܰ'
...
redis:srem(TuBaKx..'Owners'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
status  = '\n܁༯┆تم تنزيل العضو من المدراء 💞 ܰ'
...
redis:sadd(TuBaKx.."Mod:User"..msg.chat_id_, admins[i].user_id_)
num2 = num2 + 1
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,b) 
if b.username_ == true then
end
if b.first_name_ == false then
redis:srem(TuBaKx.."Mod:User"..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
redis:srem(TuBaKx.."Mod:User"..msg.chat_id_, admins[i].user_id_)
...
function start_function(extra, result, success)
if redis:get(TuBaKx..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
...
redis:sadd(TuBaKx..'Mod:User'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
status  = '\n܁༯┆تم رفع العضو ادمن 💞 ܰ'
...
redis:srem(TuBaKx..'Mod:User'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
status  = '\n܁༯┆تم تنزيل العضو من الادمنية ?? ܰ'
...
if redis:get(TuBaKx..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
...
local list = redis:smembers(TuBaKx..'Vips:User'..msg.chat_id_)
t = "\n٭ 𖤓┆قائمة المميزين 💞💞◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do
local username = redis:get(TuBaKx.."user:Name" .. v)
if username then
...
redis:sadd(TuBaKx..'Vips:User'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
local  statuss  = '\n܁༯┆تم رفع العضو مميز 💞 ܰ '
...
redis:srem(TuBaKx..'Vips:User'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
status  = '\n܁༯┆تم تنزيل العضو من المميزين 💞 ܰ'
...
redis:del(TuBaKx..'Ban:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n܁༯┆تم مسح المحظورين 💞 ܰ')
end
if text == ("المحظورين") then
local list = redis:smembers(TuBaKx..'Ban:User'..msg.chat_id_)
t = "\n٭ 𖤓┆قائمة المحظورين 💞💞◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do
local username = redis:get(TuBaKx.."user:Name" .. v)
if username then
...
redis:sadd(TuBaKx..'Ban:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁༯┆ههلو عمري 💞 ܰ'
...
redis:sadd(TuBaKx..'Ban:User'..msg.chat_id_, result.id_)
usertext = '\n܁༯┆ههلو عمري 💞 ܰ'
status  = '\n܁༯┆تم حظر العضو بنجاح 💞 ܰ'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
...
redis:sadd(TuBaKx..'Ban:User'..msg.chat_id_, userid)
chat_kick(msg.chat_id_, userid)  
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n܁༯┆ههلو عمري 💞 ܰ'
...
redis:srem(TuBaKx..'Ban:User'..msg.chat_id_, userid)
...
redis:del(TuBaKx..'Muted:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '܁༯┆تم مسح المكتومين 💞 ܰ ')
end
if text == ("المكتومين") and Mod(msg) then
local list = redis:smembers(TuBaKx..'Muted:User'..msg.chat_id_)
t = "\n٭ 𖤓┆قائمة المكتومين 😹😭💞◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do
local username = redis:get(TuBaKx.."user:Name" .. v)
if username then
...
redis:sadd(TuBaKx..'Muted:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁༯┆ههلو عمري 💞 ܰ'
...
redis:sadd(TuBaKx..'Muted:User'..msg.chat_id_, result.id_)
usertext = '\n܁༯┆ههلو عمري 💞 ܰ'
status  = '\n܁༯┆العضو تم ◃ كتمةه ههناا  💞 ܰ' 
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
...
redis:sadd(TuBaKx..'Muted:User'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n܁༯┆هلو عمري 💞 ܰ'
status  = '\n܁༯┆تم كتم العضو هنا 💞 ܰ'
...
redis:srem(TuBaKx..'Muted:User'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n܁༯┆هلو عمري 💞 ܰ'
status  = '\n܁༯┆تم الغاء كتم العضو هنا 💞 ܰ'
...
redis:set(TuBaKx.."Constructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"܁༯┆تم تغير رد المنشئ الى ◃ "..Teext)
end
if text and text:match("^تغير رد المدير (.*)$") and Owners(msg) then
local Teext = text:match("^تغير رد المدير (.*)$") 
redis:set(TuBaKx.."Owners:Rd"..msg.chat_id_,Teext) 
send(msg.chat_id_, msg.id_,"܁༯┆تم تغير رد المدير الى ◃ "..Teext)
end
if text and text:match("^تغير رد الادمن (.*)$") and Owners(msg) then
local Teext = text:match("^تغير رد الادمن (.*)$") 
redis:set(TuBaKx.."Mod:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"܁༯┆تم تغير رد الادمن الى ◃ "..Teext)
end
if text and text:match("^تغير رد المميز (.*)$") and Owners(msg) then
local Teext = text:match("^تغير رد المميز (.*)$") 
redis:set(TuBaKx.."Vips:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"܁༯┆تم تغير رد المميز الى ◃ "..Teext)
end
if text and text:match("^تغير رد العضو (.*)$") and Owners(msg) then
local Teext = text:match("^تغير رد العضو (.*)$") 
redis:set(TuBaKx.."Memp:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"܁༯┆تم تغير رد العضو الى ◃ "..Teext)
end
if text == 'مسح رد العضو' and Mod(msg) then
redis:del(TuBaKx..'Memp:Rd'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '܁༯┆تم مسح رد العضو 💞 ܰ ')
end
if text == 'مسح رد المميز' and Mod(msg) then
redis:del(TuBaKx..'Vips:Rd'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '܁༯┆تم مسح رد المميز 💞 ܰ ')
end
if text == 'مسح رد الادمن' and Mod(msg) then
redis:del(TuBaKx..'Mod:Rd'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '܁༯┆تم مسح رد الادمن 💞 ܰ ')
end
if text == 'مسح رد المدير' and Mod(msg) then
redis:del(TuBaKx..'Owners:Rd'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '܁༯┆تم مسح رد المدير💞 ܰ ')
end
if text == 'مسح رد المنشئ' and Mod(msg) then
redis:del(TuBaKx..'Constructor:Rd'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '܁༯┆تم مسح رد المنشئ 💞 ܰ ')
end
if text == 'مسح رد المنشئ الاساسي' and Mod(msg) then
redis:del(TuBaKx..'BasicConstructor:Rd'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '܁༯┆تم مسح رد المنشئ الاساسي 💞 ܰ ')
end
if text == 'مسح رد المطور' and Mod(msg) then
redis:del(TuBaKx..'Sudo:Rd'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '܁༯┆تم مسح رد المطور 💞 ܰ ')
end

if text and text:match("^(.*)$") then
if redis:get(TuBaKx..'help'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, '📮┆ تم حفظ الكليشه بنجاح')
redis:del(TuBaKx..'help'..msg.sender_user_id_)
redis:set(TuBaKx..'help_text',text)
return false
end
end
if text and text:match("^(.*)$") then
if redis:get(TuBaKx..'help1'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, '📮┆ تم حفظ الكليشه بنجاح')
redis:del(TuBaKx..'help1'..msg.sender_user_id_)
redis:set(TuBaKx..'help1_text',text)
return false
end
end
if text and text:match("^(.*)$") then
if redis:get(TuBaKx..'help2'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, '📮┆ تم حفظ الكليشه بنجاح')
redis:del(TuBaKx..'help2'..msg.sender_user_id_)
redis:set(TuBaKx..'help2_text',text)
return false
end
end

if text and text:match("^(.*)$") then
if redis:get(TuBaKx..'help3'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, '📮┆ تم حفظ الكليشه بنجاح')
redis:del(TuBaKx..'help3'..msg.sender_user_id_)
redis:set(TuBaKx..'help3_text',text)
return false
end
end
if text and text:match("^(.*)$") then
if redis:get(TuBaKx..'help4'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, '??┆ تم حفظ الكليشه بنجاح')
redis:del(TuBaKx..'help4'..msg.sender_user_id_)
redis:set(TuBaKx..'help4_text',text)
return false
end
end
if text and text:match("^(.*)$") then
if redis:get(TuBaKx..'help5'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, '📮┆ تم حفظ الكليشه بنجاح')
redis:del(TuBaKx..'help5'..msg.sender_user_id_)
redis:set(TuBaKx..'help5_text',text)
return false
end
end
if text and text:match("^(.*)$") then
if redis:get(TuBaKx..'help6'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, '📮┆ تم حفظ الكليشه بنجاح')
redis:del(TuBaKx..'help6'..msg.sender_user_id_)
redis:set(TuBaKx..'help6_text',text)
return false
end
end
if text and text:match("^(.*)$") then
if redis:get(TuBaKx..'help7'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, '📮┆ تم حفظ الكليشه بنجاح')
redis:del(TuBaKx..'help7'..msg.sender_user_id_)
redis:set(TuBaKx..'help7_text',text)
return false
end
end
if text and text:match("^(.*)$") then
if redis:get(TuBaKx..'help8'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, '??┆ تم حفظ الكليشه بنجاح')
redis:del(TuBaKx..'help8'..msg.sender_user_id_)
redis:set(TuBaKx..'help8_text',text)
return false
end
end
if text and text:match("^(.*)$") then
if redis:get(TuBaKx..'help9'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, '📮┆ تم حفظ الكليشه بنجاح')
redis:del(TuBaKx..'help9'..msg.sender_user_id_)
redis:set(TuBaKx..'help9_text',text)
return false
end
end

if text == 'استعاده الاوامر' and Sudo_TuBaKx(msg) then
redis:del(TuBaKx..'help_text')
redis:del(TuBaKx..'help1_text')
redis:del(TuBaKx..'help2_text')
redis:del(TuBaKx..'help3_text')
redis:del(TuBaKx..'help4_text')
redis:del(TuBaKx..'help5_text')
redis:del(TuBaKx..'help6_text')
redis:del(TuBaKx..'help7_text')
redis:del(TuBaKx..'help8_text')
redis:del(TuBaKx..'help9_text')
send(msg.chat_id_, msg.id_, '🔘┆ تم استعادة الاوامر القديمه')
end
if text == 'تغير امر الاوامر' and Sudo_TuBaKx(msg) then
send(msg.chat_id_, msg.id_, '܁༯┆ارسل كليشة الامر الان ◃ 💞 ܰ')
redis:set(TuBaKx..'help'..msg.sender_user_id_,'true')
return false 
end
if text == 'تغير امر م1' and Sudo_TuBaKx(msg) then
send(msg.chat_id_, msg.id_, '🔘┆ الان يمكنك ارسال الكليشه م1')
redis:set(TuBaKx..'help1'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر م2' and Sudo_TuBaKx(msg) then
send(msg.chat_id_, msg.id_, '🔘┆ الان يمكنك ارسال الكليشه م2')
redis:set(TuBaKx..'help2'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر م3' and Sudo_TuBaKx(msg) then
send(msg.chat_id_, msg.id_, '🔘┆ الان يمكنك ارسال الكليشه م3')
redis:set(TuBaKx..'help3'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر م4' and Sudo_TuBaKx(msg) then
send(msg.chat_id_, msg.id_, '🔘┆ الان يمكنك ارسال الكليشه م4')
redis:set(TuBaKx..'help4'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر م5' and Sudo_TuBaKx(msg) then
send(msg.chat_id_, msg.id_, '🔘┆ الان يمكنك ارسال الكليشه م5')
redis:set(TuBaKx..'help5'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر م6' and Sudo_TuBaKx(msg) then
send(msg.chat_id_, msg.id_, '🔘┆ الان يمكنك ارسال الكليشه م6')
redis:set(TuBaKx..'help6'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر م7' and Sudo_TuBaKx(msg) then
send(msg.chat_id_, msg.id_, '🔘┆ الان يمكنك ارسال الكليشه م7')
redis:set(TuBaKx..'help7'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر م8' and Sudo_TuBaKx(msg) then
send(msg.chat_id_, msg.id_, '🔘┆ الان يمكنك ارسال الكليشه م8')
redis:set(TuBaKx..'help8'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر م9' and Sudo_TuBaKx(msg) then
send(msg.chat_id_, msg.id_, '🔘┆ الان يمكنك ارسال الكليشه م9')
redis:set(TuBaKx..'help9'..msg.sender_user_id_,'true')
return false 
end
...
if redis:get(TuBaKx..'Lock:Games'..msg.chat_id_) then
redis:del(TuBaKx..'Set:Sma'..msg.chat_id_)
Random = {'🍏','🍎','🍐','🍊','🍋','🍉','🍇','🍓','🍈','🍒','🍑','🍍','🥥','🥝','🍅','🍆','🥑','🥦','🥒','🌶','🌽','🥕','🥔','??','🥐','🍞','🥨','🍟','🧀','🥚','??','🥓','🥩','🍗','🍖','🌭','🍔','🍠','🍕','🥪','🥙','☕️','🍵','🥤','🍶','🍺','🍻','🏀','⚽️','🏈','⚾️','🎾','🏐','🏉','🎱','🏓','🏸','🥅','🎰','🎮','🎳','🎯','🎲','🎻','🎸','🎺','🥁','🎹','🎼','🎧','🎤','🎬','🎨','🎭','🎪','🎟','🎫','🎗','🏵','🎖','🏆','🥌','🛷','🚗','🚌','🏎','🚓','🚑','🚚','🚛','🚜','🇮🇶','⚔','🛡','??','🌡','💣','📌','📍','??','📗','📂','📅','📪','☑','📬','📭','⏰','📺','??','☎️','📡'}
SM = Random[math.random(#Random)]
redis:set(TuBaKx..'Random:Sm'..msg.chat_id_,SM)
send(msg.chat_id_, msg.id_,'܁༯┆اسرع واحد يدز لسمايل  ◃ ˼ `'..SM..'` ˹ 💞 ܰ')
return false
end
end
if text == ''..(redis:get(TuBaKx..'Random:Sm'..msg.chat_id_) or '')..'' and not redis:get(TuBaKx..'Set:Sma'..msg.chat_id_) then
if not redis:get(TuBaKx..'Set:Sma'..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'܁༯┆ويانا فائز ككلللوش 😂😭💞 ܰ')
redis:incrby(TuBaKx..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(TuBaKx..'Set:Sma'..msg.chat_id_,true)
return false
end 
...
if redis:get(TuBaKx..'Lock:Games'..msg.chat_id_) then
redis:del(TuBaKx..'Speed:Tr'..msg.chat_id_)
KlamSpeed = {'سحور','سياره','استقبال','قنفه','ايفون','بزونه','مطبخ','كرستيانو','دجاجه','مدرسه','الوان','غرفه','ثلاجه','كهوه','سفينه','العراق','محطه','طياره','رادار','منزل','مستشفى','كهرباء','تفاحه','اخطبوط','سلمون','فرنسا','برتقاله','تفاح','مطرقه','بتيته','لهانه','شباك','باص','سمكه','ذباب','تلفاز','حاسوب','انترنيت','ساحه','جسر'};
name = KlamSpeed[math.random(#KlamSpeed)]
redis:set(TuBaKx..'Klam:Speed'..msg.chat_id_,name)
...
------------------------------------------------------------------------
if text == ''..(redis:get(TuBaKx..'Klam:Speed'..msg.chat_id_) or '')..'' and not redis:get(TuBaKx..'Speed:Tr'..msg.chat_id_) then
if not redis:get(TuBaKx..'Speed:Tr'..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'܁༯┆ويانا فائز ككلللوش 😂😭💞 ܰ')
redis:incrby(TuBaKx..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(TuBaKx..'Speed:Tr'..msg.chat_id_,true)
end 
...
if redis:get(TuBaKx..'Lock:Games'..msg.chat_id_) then
redis:del(TuBaKx..'Set:Hzora'..msg.chat_id_)
...
redis:set(TuBaKx..'Klam:Hzor'..msg.chat_id_,name)
...
------------------------------------------------------------------------
if text == ''..(redis:get(TuBaKx..'Klam:Hzor'..msg.chat_id_) or '')..'' and not redis:get(TuBaKx..'Set:Hzora'..msg.chat_id_) then
if not redis:get(TuBaKx..'Set:Hzora'..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'܁༯┆ويانا فائز ككلللوش 😂😭💞 ܰ')
redis:incrby(TuBaKx..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(TuBaKx..'Set:Hzora'..msg.chat_id_,true)
end 
...
if redis:get(TuBaKx..'Lock:Games'..msg.chat_id_) then
redis:del(TuBaKx..'Set:Maany'..msg.chat_id_)
Maany_Rand = {'قرد','دجاجه','بطريق','ضفدع','بومه','نحله','ديك','جمل','بقره','دولفين','تمساح','قرش','نمر','اخطبوط','سمكه','خفاش','اسد','فأر','ذئب','فراشه','عقرب','زرافه','قنفذ','تفاحه','باذنجان'}
name = Maany_Rand[math.random(#Maany_Rand)]
redis:set(TuBaKx..'Maany'..msg.chat_id_,name)
...
------------------------------------------------------------------------
if text == ''..(redis:get(TuBaKx..'Maany'..msg.chat_id_) or '')..'' and not redis:get(TuBaKx..'Set:Maany'..msg.chat_id_) then
if not redis:get(TuBaKx..'Set:Maany'..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'܁༯┆ويانا فائز ككلللوش 😂😭💞 ܰ')
redis:incrby(TuBaKx..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(TuBaKx..'Set:Maany'..msg.chat_id_,true)
end 
if text == 'العكس' then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_, msg.id_,'- هلو حب ، لايمكنك استخدام البوت 💕.\n- ﭑشترك اولاً 💕 • ['..redis:get(TuBaKx..'add:ch:username')..'] .')
...
if redis:get(TuBaKx..'Lock:Games'..msg.chat_id_) then
redis:del(TuBaKx..'Set:Aks'..msg.chat_id_)
katu = {'باي','فهمت','موزين','اسمعك','احبك','موحلو','نضيف','حاره','ناصي','جوه','سريع','ونسه','طويل','سمين','ضعيف','شريف','شجاع','رحت','عدل','نشيط','شبعان','موعطشان','خوش ولد','اني','هادئ'}
name = katu[math.random(#katu)]
redis:set(TuBaKx..'Set:Aks:Game'..msg.chat_id_,name)
...
------------------------------------------------------------------------
if text == ''..(redis:get(TuBaKx..'Set:Aks:Game'..msg.chat_id_) or '')..'' and not redis:get(TuBaKx..'Set:Aks'..msg.chat_id_) then
if not redis:get(TuBaKx..'Set:Aks'..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'܁༯┆ويانا فائز ككلللوش 😂😭💞 ܰ')
redis:incrby(TuBaKx..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(TuBaKx..'Set:Aks'..msg.chat_id_,true)
end 

if redis:get(TuBaKx.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
send(msg.chat_id_, msg.id_,"܁༯┆ عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }💞 ܰ\n")
return false  end 
local GETNUM = redis:get(TuBaKx.."GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
redis:del(TuBaKx..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
redis:del(TuBaKx.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
redis:incrby(TuBaKx..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,5)  
send(msg.chat_id_, msg.id_,'܁༯┆ مبروك فزت ويانه وخمنت الرقم الصحيح 💞 ܰ\n܁༯┆ تم اضافة { 5 } من النقاط 💞 ܰ\n')
elseif tonumber(NUM) ~= tonumber(GETNUM) then
redis:incrby(TuBaKx..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(redis:get(TuBaKx..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)) >= 3 then
redis:del(TuBaKx..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
redis:del(TuBaKx.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
redis:set(TuBaKx.."GAMES:NUM"..msg.chat_id_,Num) 
...
redis:setex(TuBaKx.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
end

if redis:get(TuBaKx.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
send(msg.chat_id_, msg.id_,"܁༯┆عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخرى 💞 ܰ\n")
return false  end 
local GETNUM = redis:get(TuBaKx.."Games:Bat"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
redis:del(TuBaKx.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,'܁༯┆ويانا فائز ككلللوش 😂😭💞 ܰ')
redis:incrby(TuBaKx..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,3)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
redis:del(TuBaKx.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
if redis:get(TuBaKx..'Lock:Games'..msg.chat_id_) then   
Num = math.random(1,6)
redis:set(TuBaKx.."Games:Bat"..msg.chat_id_,Num) 
TEST = [[
...
redis:setex(TuBaKx.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
end
...
redis:del(TuBaKx..'Set:Moktlf:Bot'..msg.chat_id_)
redis:set(TuBaKx..':Set:Moktlf'..msg.chat_id_,name)
...
------------------------------------------------------------------------
if text == ''..(redis:get(TuBaKx..':Set:Moktlf'..msg.chat_id_) or '')..'' then 
if not redis:get(TuBaKx..'Set:Moktlf:Bot'..msg.chat_id_) then 
redis:del(TuBaKx..':Set:Moktlf'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'܁༯┆ويانا فائز ككلللوش ??😭💞 ܰ')
redis:incrby(TuBaKx..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(TuBaKx..'Set:Moktlf:Bot'..msg.chat_id_,true)
end
------------------------------------------------------------------------
...
redis:del(TuBaKx..'Set:Ryadeat:Bot'..msg.chat_id_)
redis:set(TuBaKx..':Set:Ryadeat'..msg.chat_id_,name)
...
------------------------------------------------------------------------
if text == ''..(redis:get(TuBaKx..':Set:Ryadeat'..msg.chat_id_) or '')..'' then 
if not redis:get(TuBaKx..'Set:Ryadeat:Bot'..msg.chat_id_) then 
redis:del(TuBaKx..':Set:Ryadeat'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'܁༯┆ويانا فائز ككلللوش 😂😭💞 ܰ')
redis:incrby(TuBaKx..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(TuBaKx..'Set:Ryadeat:Bot'..msg.chat_id_,true)
end
------------------------------------------------------------------------
...
name = Hussein[math.random(#Hussein)]
redis:del(TuBaKx..'Set:English:Bot'..msg.chat_id_)
redis:set(TuBaKx..':Set:English'..msg.chat_id_,name)
...
------------------------------------------------------------------------
if text == ''..(redis:get(TuBaKx..':Set:English'..msg.chat_id_) or '')..'' then 
if not redis:get(TuBaKx..'Set:English:Bot'..msg.chat_id_) then 
redis:del(TuBaKx..':Set:English'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'܁༯┆ويانا فائز ككلللوش 😂😭💞 ܰ')
redis:incrby(TuBaKx..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(TuBaKx..'Set:English:Bot'..msg.chat_id_,true)
end
------------------------------------------------------------------------
...
redis:set(TuBaKx..'Set:Amth'..msg.chat_id_,name)
redis:del(TuBaKx..'Set:Amth:Bot'..msg.chat_id_)
...
------------------------------------------------------------------------
if text == ''..(redis:get(TuBaKx..'Set:Amth'..msg.chat_id_) or '')..'' then 
if not redis:get(TuBaKx..'Set:Amth:Bot'..msg.chat_id_) then 
redis:del(TuBaKx..'Set:Amth'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'܁༯┆ويانا فائز ككلللوش 😂😭💞 ܰ')
redis:incrby(TuBaKx..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(TuBaKx..'Set:Amth:Bot'..msg.chat_id_,true)
end
if text == 'تعطيل الالعاب' and Owners(msg) then  
send(msg.chat_id_, msg.id_, '\n܁༯┆ههلو عمري 💞 ܰ \n܁༯┆تم تعطيل الالعاب 💞 ܰ')
redis:del(TuBaKx..'Lock:Games'..msg.chat_id_) 
end
if text == 'تفعيل الالعاب' and Owners(msg) then  
send(msg.chat_id_, msg.id_, '܁༯┆ههلو عمري 💞 ܰ \n܁༯┆تم تفعيل الالعاب 💞 ܰ')
redis:set(TuBaKx..'Lock:Games'..msg.chat_id_,true) 
end

if text == 'الالعاب' or text == 'اللعبه' and redis:get(TuBaKx..'Lock:Games'..msg.chat_id_) then
Text_Games = [[
٭ 𖤓┆قائمة الالعاب 💞◟
܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀
...
local help_text = redis:get(TuBaKx..'help_text')
Text = [[
܁༯┆ اهلا بيك عمري 💞 . 
܁༯┆اوامر البوت ▾ . 
܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀
