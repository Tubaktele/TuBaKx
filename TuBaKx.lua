...
if text == 'الملفات' and Sudo_TuBaKx(msg) then
...
if Sudo_TuBaKx(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TuBaKxTeam/TuBaKx_File/master/getfile.json")
if res == 200 then
...
local Check_File_is_Found = io.open("File_TuBaKx/"..name,"r")
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and Sudo_TuBaKx(msg) then
local name_t = {string.match(text, "^(تعطيل) (.*)(.lua)$")}
local file = name_t[2]..'.lua'
local file_bot = io.open("File_TuBaKx/"..file,"r")
if file_bot then
io.close(file_bot)
t = "܁༯┆الملف ▸ "..file.."\n܁༯┆تم تعطيل ملف \n"
else
...
local json_file, res = https.request("https://raw.githubusercontent.com/TuBaKxTeam/TuBaKx_File/master/plugins_/"..file)
if res == 200 then
os.execute("rm -fr File_TuBaKx/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('TuBaKx.lua')  
else
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and Sudo_TuBaKx(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/TuBaKxTeam/TuBaKx_File/master/plugins_/"..file)
if res == 200 then
local chek = io.open("File_TuBaKx/"..file,'w+')
...
if text == "مسح الملفات" and Sudo_TuBaKx(msg) then
os.execute("rm -fr File_TuBaKx/*")
